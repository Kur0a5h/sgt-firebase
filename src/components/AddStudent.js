  ...
  render() {
    return (
        <Form error>
          ...
          <Form.Field required>
            <label>Course</label>
            <input placeholder='Course' name='course' value={this.inputFields.course} onChange={this.handleChange}/>
            <Message error content={this.courseError.msg}/>
          </Form.Field>
          <Form.Field required>
            <label>Grade</label>
            <input placeholder='Grade' name='grade' value={this.inputFields.grade} onChange={this.handleChange}/>
